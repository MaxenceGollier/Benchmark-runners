# Copied verbatim from Penelopt.jl's benchmark/utils/trust-region-nls.jl
# (source shared with us directly by the repo owner). Purely a generic
# NLPModels/NLPModelsModifiers construct — no solver-specific code — so
# it's reused as-is for the MadNLP and Uno infeasibility certifiers.
